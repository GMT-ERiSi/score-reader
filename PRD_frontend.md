...
| FRF201          | 2     | Interactive Leaderboards (Sort/Filter)       | As a user viewing leaderboards, I want to sort by columns and filter the data so I can analyze rankings more effectively. | Implement JavaScript to add client-side sorting to all leaderboard tables.                                        |
